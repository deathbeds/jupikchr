...
html_theme_options = {
    ...
    "icon_links": [
        {
            "name": "PyPI",
            "url": "https://pypi.org/project/jupikchr",
            "icon": "fa-brands fa-python",
        },
        {
            "name": "conda-forge",
            "url": "https://github.com/conda-forge/jupikchr-feedstock#about-jupikchr",
            "icon": "_static/anvil.svg",
            "type": "local",
        },
        {
            "name": "npm",
            "url": "https://www.npmjs.com/package/@deathbeds/jupikchr",
